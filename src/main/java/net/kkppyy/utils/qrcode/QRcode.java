...
//	    hints.put(EncodeHintType.MIN_SIZE, 100);//设置图片的最小值
		...
		// 生成二维码
		File outputFile = new File(outPath + File.separator + "new.jpg");//指定输出路径
		
		MatrixToImageWriter.writeToFile(bitMatrix, format, outputFile,login,titleimage,title,intro);
	}
